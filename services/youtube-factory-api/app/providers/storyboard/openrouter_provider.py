"""OpenRouter storyboard provider (mock delegation until API key wired)."""
...
class OpenRouterStoryboardProvider(StoryboardProvider):
    name = "openrouter"
    ...
    async def _fetch_raw(
        ...
        return generate_mock_storyboard("openrouter", request, script_data)
